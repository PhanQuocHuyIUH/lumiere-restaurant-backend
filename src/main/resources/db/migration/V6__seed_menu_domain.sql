-- =====================================================
-- V6: Seed menu domain — categories, items (with tax),
--     combos, inventory ingredients, and item recipes.
--     Also seeds system_settings defaults.
--
--     Tax rules (INCLUSIVE, stored as gross price_vnd):
--       • Food & non-alcoholic drinks : 8%  (800 bps)
--       • Alcoholic beverages         : 10% (1000 bps)
-- =====================================================

-- ─────────────────────────────────────────────
-- 0. SYSTEM SETTINGS DEFAULTS
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- 2. SINGLE MENU ITEMS
--    Columns: category_name, item_name, item_description,
--             price_vnd (BIGINT, gross inclusive),
--             cook_time, image_url, image_public_id,
--             is_available, item_tax_mode, item_tax_rate_bps
-- ─────────────────────────────────────────────
INSERT INTO menu.menu_items (
    category_id, name, description, price_vnd, cook_time,
    image_url, image_public_id, is_available,
    item_tax_mode, item_tax_rate_bps
)
SELECT c.id, v.item_name, v.item_description, v.price_vnd::BIGINT, v.cook_time,
       v.image_url, v.image_public_id, v.is_available::BOOLEAN,
       v.item_tax_mode, v.item_tax_rate_bps::INT
FROM (VALUES
    -- ── Khai Vị & Salad ──────────────────────────────────────────────
    ('Khai Vị & Salad', 'Cua Xanh Cà Mau & Hàu Tươi',
     ...
     'lumiere/menu-items/rlu6yzybbuwrutnl6aj8', 'true', 'INCLUSIVE', '800'),
    ('Khai Vị & Salad', 'Gan Ngỗng Áp Chảo',
     ...
     'lumiere/menu-items/bg9jkesb9mcxms5fikzj', 'true', 'INCLUSIVE', '800'),
    ('Khai Vị & Salad', 'Sò Điệp Hấp & Quenelle',
     ...
     'lumiere/menu-items/ltik87mzo9hunxqqcloz', 'true', 'INCLUSIVE', '800'),
    ('Khai Vị & Salad', 'Ốc Pháp Nướng',
     ...
     'lumiere/menu-items/wahwmulp6ufntl0603ms', 'true', 'INCLUSIVE', '800'),
    ('Khai Vị & Salad', 'Thịt Bò Carpaccio',
     ...
     'lumiere/menu-items/ahescnlrs1ejkmasllec', 'true', 'INCLUSIVE', '800'),
    ('Khai Vị & Salad', 'Khay Thịt Nguội & Phô Mai Tổng Hợp',
     ...
     'lumiere/menu-items/xrhocyf6mtcgupv0ezmb', 'true', 'INCLUSIVE', '800'),
    ('Khai Vị & Salad', 'Xà Lách Burrata',
     ...
     'lumiere/menu-items/lmvdbk1ablbekaoi7yw7', 'true', 'INCLUSIVE', '800'),
    ...
    ('Súp', 'Súp Nấm Truffle',
     ...
     'lumiere/menu-items/tpcg9ltjatypxw0nzv6n', 'true', 'INCLUSIVE', '800'),
    ('Súp', 'Súp Hành Tây Phô Mai Đút Lò',
     ...
     'lumiere/menu-items/eb53vxvxph5sbkmz4cgc', 'true', 'INCLUSIVE', '800'),
    ('Súp', 'Súp Tôm Hùm & Tôm Sú',
     ...
     'lumiere/menu-items/rzxxsukkdrezrybxenug', 'true', 'INCLUSIVE', '800'),
    ...
    ('Món Chính - Bò & Cừu', 'Thăn Bò Tartar',
     ...
     'lumiere/menu-items/lndb1ble4tznmmg4mnsc', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Bò & Cừu', 'Thăn Bò Bít Tết (Steak Frites)',
     ...
     'lumiere/menu-items/whs8mikqfvxlobbpctiw', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Bò & Cừu', 'Bò Wellington',
     ...
     'lumiere/menu-items/yiqht0hi66uamul6ltin', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Bò & Cừu', 'Sườn Cừu New Zealand Nướng',
     ...
     'lumiere/menu-items/njbq35s85gulrwixxkgd', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Bò & Cừu', 'Sườn Bò Nướng Côte de Boeuf (Cho 2 người)',
     ...
     'lumiere/menu-items/plvptqumz60amtnondbn', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Bò & Cừu', 'Burger Bò The Bistro',
     ...
     'lumiere/menu-items/ozmd38gapz8uqdwdemzc', 'true', 'INCLUSIVE', '800'),
    ...
    ('Món Chính - Gia Cầm & Heo', 'Ức Vịt Áp Chảo Sốt Cam',
     ...
     'lumiere/menu-items/l0maekay9jemlfbdy6as', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Gia Cầm & Heo', 'Đùi Gà Rút Xương Nướng Chậm',
     ...
     'lumiere/menu-items/muaef1fc1vdgwhhome2a', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Gia Cầm & Heo', 'Đùi Vịt Hầm Confit',
     ...
     'lumiere/menu-items/pmnjyguhc1rzcqfeycub', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Gia Cầm & Heo', 'Gà Cordon Bleu',
     ...
     'lumiere/menu-items/fgsayoxvcmeqke9uq0kk', 'true', 'INCLUSIVE', '800'),
    ...
    ('Món Chính - Hải Sản', 'Cá Hồi Áp Chảo',
     ...
     'lumiere/menu-items/pswcmstavk5un95ilhz2', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Hải Sản', 'Cá Tuyết Patagonia Nóng Lạnh',
     ...
     'lumiere/menu-items/qgypikggnb4hum2ewb1y', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Hải Sản', 'Tôm Hùm Xanh',
     ...
     'lumiere/menu-items/dgkpipmgz1h2ikrow0a8', 'true', 'INCLUSIVE', '800'),
    ('Món Chính - Hải Sản', 'Cá Chẽm Sốt Mù Tạt',
     ...
     'lumiere/menu-items/cbhrcccnscgjoiutogzv', 'true', 'INCLUSIVE', '800'),
    ...
    ('Mì Ý & Cơm Ý', 'Spaghetti Nghêu Vongole',
     ...
     'lumiere/menu-items/ux7jogzhumhdqc72xksm', 'true', 'INCLUSIVE', '800'),
    ('Mì Ý & Cơm Ý', 'Lasagna Bò & Cà Chua',
     ...
     'lumiere/menu-items/tqyojprmqldofjtnzfor', 'true', 'INCLUSIVE', '800'),
    ('Mì Ý & Cơm Ý', 'Fettuccine Phô Mai Dê',
     ...
     'lumiere/menu-items/qjirayxhinldnhtyx14g', 'true', 'INCLUSIVE', '800'),
    ('Mì Ý & Cơm Ý', 'Risotto Hải Sản',
     ...
     'lumiere/menu-items/zqfs5qa2lemawe3nxdfd', 'true', 'INCLUSIVE', '800'),
    ...
    ('Món Ăn Kèm & Bánh Mì', 'Bánh Mì Croque Monsieur',
     ...
     'lumiere/menu-items/wecvefyy82umewzresls', 'true', 'INCLUSIVE', '800'),
    ('Món Ăn Kèm & Bánh Mì', 'Burger Chay Phô Mai Dê',
     ...
     'lumiere/menu-items/lqnaf7cdf9c8vwiaqpat', 'true', 'INCLUSIVE', '800'),
    ('Món Ăn Kèm & Bánh Mì', 'Rau Củ Hầm Ratatouille',
     ...
     'lumiere/menu-items/gxz1kynglhn1eh58l4hx', 'true', 'INCLUSIVE', '800'),
    ('Món Ăn Kèm & Bánh Mì', 'Khoai Tây Chiên',
     ...
     'lumiere/menu-items/mlkhnwok3gbxfchtqyc4', 'true', 'INCLUSIVE', '800'),
    ...
    ('Tráng Miệng', 'Bánh Crepe Suzette',
     ...
     'lumiere/menu-items/oc2p7n3ighs7efaz2dxl', 'true', 'INCLUSIVE', '800'),
    ('Tráng Miệng', 'Bánh Profiteroles Nhân Nutella',
     ...
     'lumiere/menu-items/jhsvyol9q6ey8vo9zdke', 'true', 'INCLUSIVE', '800'),
    ('Tráng Miệng', 'Xoài Nướng Kiểu Việt',
     ...
     'lumiere/menu-items/qrdrjyf97j79lxgvfpmy', 'true', 'INCLUSIVE', '800'),
    ('Tráng Miệng', 'Bánh Tart Táo Úp Ngược (Tarte Tatin)',
     ...
     'lumiere/menu-items/t66hp9hglvmbcrgnukty', 'true', 'INCLUSIVE', '800'),
    ('Tráng Miệng', 'Tiramisu Truyền Thống',
     ...
     'lumiere/menu-items/rxkangetyxxafycxqgh5', 'true', 'INCLUSIVE', '800'),

    -- ── Thức Uống & Rượu Vang ── non-alcoholic: 8%, alcoholic: 10% ──
    ('Thức Uống & Rượu Vang', 'Set Cà Phê Gourmand',
     ...
     'lumiere/menu-items/fuif6w8tbgedukn5exfq', 'true', 'INCLUSIVE', '800'),
    -- alcoholic: Vodka + Kahlúa → 10%
    ('Thức Uống & Rượu Vang', 'Cocktail Espresso Martini',
     ...
     'lumiere/menu-items/aiqedlawww0auvntvcbb', 'true', 'INCLUSIVE', '1000'),
    -- alcoholic: Champagne → 10%
    ('Thức Uống & Rượu Vang', 'Champagne Beaumont des Crayères',
     ...
     'lumiere/menu-items/ic6r2y62yg46a1r5z5xr', 'true', 'INCLUSIVE', '1000'),
    ('Thức Uống & Rượu Vang', 'Trà & Trà Thảo Mộc',
     ...
     'lumiere/menu-items/wew0aazdu8mygcq5c6hz', 'true', 'INCLUSIVE', '800'),
    ('Thức Uống & Rượu Vang', 'Nước Khoáng Thiên Nhiên',
     ...
     'lumiere/menu-items/lico0ltnbhhglox20ibt', 'true', 'INCLUSIVE', '800'),
    -- alcoholic: Red wine → 10%
    ('Thức Uống & Rượu Vang', 'Rượu Vang Đỏ Château Merlet (Bordeaux) - Ly',
     ...
     'lumiere/menu-items/ydazvf6bgrvuijk6lcqk', 'true', 'INCLUSIVE', '1000'),
    -- alcoholic: White wine → 10%
    ('Thức Uống & Rượu Vang', 'Rượu Vang Trắng Sauvignon Blanc - Ly',
     ...
     'lumiere/menu-items/svefzmsuab5jgshvcskh', 'true', 'INCLUSIVE', '1000'),
    -- alcoholic: Beer → 10%
    ('Thức Uống & Rượu Vang', 'Bia Tươi Kronenbourg 1664 Blanc',
     ...
     'lumiere/menu-items/day4jzzp3qk90onfwhsu', 'true', 'INCLUSIVE', '1000')
) AS v(category_name, item_name, item_description, price_vnd, cook_time,
       image_url, image_public_id, is_available, item_tax_mode, item_tax_rate_bps)
...
-- 3.1 FIXED combo: Seafood Duo Combo (food → 8%)
INSERT INTO menu.menu_items (
    category_id, name, description, price_vnd, cook_time,
...
-- 3.2 PICK combo: Lunch Set (1 main + 1 drink) (food → 8%)
INSERT INTO menu.menu_items (
    category_id, name, description, price_vnd, cook_time,
    image_url, image_public_id, is_available, item_type, combo_kind,
    item_tax_mode, item_tax_rate_bps
